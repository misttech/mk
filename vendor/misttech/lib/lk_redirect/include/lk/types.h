...
#ifndef VENDOR_MISTTECH_LIB_LK_REDIRECT_INCLUDE_LK_TYPES_H_
#define VENDOR_MISTTECH_LIB_LK_REDIRECT_INCLUDE_LK_TYPES_H_
...
#endif  // VENDOR_MISTTECH_LIB_LK_REDIRECT_INCLUDE_LK_TYPES_H_
