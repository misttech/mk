...
#endif
  // Large allocations are no longer allowed. See https://fxbug.dev/42106180 for details.
...
NO_ASAN void* cmpct_memalign(size_t alignment, size_t size) {
  ...
  LOCAL_TRACE_DURATION("locked", trace_lock);
#if KERNEL_ASAN
  // TODO(https://fxbug.dev/42104852): Separately poison padding and the post-buffer redzone.
